...
createPeerConnection = function() {
  try {
    ...
    try {
      ...
      alert('Failed to create data channel!'); log('createDataChannel() failed with following message: ' + e.message);
    }
...
function closeDataChannels() { // Close channels...
...
function handleSendChannelStateChange() {
  ...
  } else { // event MUST be 'close', if we are here... // Disable 'Send' text area
    // dataChannelSend.disabled = true;
